...
// const Sidebar = ({selectedUser,setSelectedUser}) => { // it is get from ChatContext.jsx
const Sidebar = () => {
  ...
  return (
    ...
    <div className='pb-5'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 mt-5 px-4 py-3'>
            ...
            <input type="text" onChange={(e)=>SetInput(e.target.value)} placeholder='Search User' className='bg-transparent outline-none border-none text-white text-xs
